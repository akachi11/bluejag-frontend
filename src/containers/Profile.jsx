    ...
    <div>
      ...
      <div className="bg-gray-950 pt-16">
        ...
        <div className="montserrat uppercase font-semibold text-xs">
          ...
          <p className="p-6">Address Book</p>
      ...
      {/* <div className="flex justify-between bg-gray-950 montserrat px-[8rem] pt-12">
        <div>
          <p className="font-semibold">OGOGOR</p>
          <p className="font-semibold">CHIMADIKA</p>

          <div className="mt-4 w-[15vw] flex items-start flex-col gap-1 text-xs font-semibold">
        ...
        <div>
          ...
          <div className="mt-8 h-30 overflow-hidden">
            <img
              src={tier1img}
              alt=""
              className="w-[30%] m-auto object-top object-cover"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 flex items-start flex-col gap-1 text-xs w-[15vw]">
