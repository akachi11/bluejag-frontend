...
const HomeRatings = () => {
  ...
  return (
    <GoinBlueContainer>
      <GBHeader className="ratings montserrat">GYM WEARS FOR EVERYONE</GBHeader>
      ...
      >
        {Array.from({ length: 6 }, (_, index) => (
          <HomeRating className="bg-gray-800">
            <HRCStars className="ratings text-gray-300">{stars(4.5)}</HRCStars>

            <RatingHead className="montserrat text-white">
              Comfort and quality
            </RatingHead>

            <RatingText className="text-white">
            ...
            <RatedProduct className="text-gray-300">
